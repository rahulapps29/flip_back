...
const { sendEmails, getRemainingEmails, resetEmailFlags,  sendEmailsToManagers, resetManagerEmailFlags, getRemainingManagerEmails  } = require('../controllers/emailController');
...
router.get('/remaining-manager-emails',authenticateToken, getRemainingManagerEmails);


// ✅ Route to send emails to managers (after employees)
router.post('/send-emails-to-managers',authenticateToken, sendEmailsToManagers);

// ✅ Route to reset manager email statuses
router.post('/reset-manager-email-status',authenticateToken, resetManagerEmailFlags);
